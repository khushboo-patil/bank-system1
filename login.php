...
<html>
    <head>
        ...
        <?php
            $con = new mysqli('localhost','root','','mybank1');
            define('bankName', 'The Sparks Foundation : Basic Banking System',false);
            ...
            if (isset($_POST['userLogin']))
                {
                    ...
                    if($result->num_rows>0)
                        ...
                        {
                            $error = "<div class='alert alert-warning text-center rounded-0'>Username or password doesn't match. Try again!</div>";
                        }
                }
    ...
    <body style="background: url(images/hello.jpg);background-size: 100%">
        <h1 class="alert alert-success rounded-0"><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 18pt;"><kbd>Presented by:Yogesh Yadav</kbd></small></h1>
        <br>
        ...
        <div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 222px">
            ...
            <div class="card rounded-0">
                ...
                <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                    <div class="card-body">
                        <form method="POST">
                            <input type="email" value="yogeshiitkgp2018@gmail.com" name="email" class="form-control" required placeholder="Enter Email">
                            <input type="password" name="password" value="Sandy@123" class="form-control" required placeholder="Enter Password">
